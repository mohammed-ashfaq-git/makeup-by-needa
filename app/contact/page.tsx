              ...
              <div className="contact-channel">
                ...
                <div className="contact-channel-main">
                  <a
                    ...
                    aria-label={`Visit ${business.instagramMakeup} on Instagram`}
                  >
                    <InstagramSvg />
                    <strong>{business.instagramMakeup}</strong>
              ...
              <div className="contact-channel">
                ...
                <div className="contact-channel-main">
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="contact-channel-link"
                    aria-label={`Visit ${business.instagramNails} on Instagram`}
                  >
                    <InstagramSvg />
                    <strong>{business.instagramNails}</strong>
                    <span className="contact-channel-arrow">
                      <ArrowSvg />
                    </span>
                  </a>
              ...
              <div className="contact-channel">
                ...
                <div className="contact-channel-main">
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="contact-channel-link"
                    aria-label={`Chat with Makeup by Needa on WhatsApp at ${business.whatsappDisplay}`}
                  >
                    <WhatsAppSvg />
              ...
              <div className="contact-channel">
                ...
                <div className="contact-channel-main">
                  <a
                    ...
                    className="contact-channel-link"
                    aria-label={`Email Makeup by Needa at ${business.email}`}
                  >
                    <EmailSvg />
